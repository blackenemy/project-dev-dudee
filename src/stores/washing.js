...
export const Machine = defineStore({
    ...
    state: () => ({
        ...
        machines: [
            { id: "1", name: "เครื่องซักผ้าฝาหน้า รุ่น FV1412S2B", status: 'working', time: 600, img: '/assets/mac01.png' },
            { id: "2", name: "เครื่องซักผ้า 2 ถัง รุ่น TT15WAPG", status: 'working', time: 1800, img: '/assets/mac02.png' },
